...
| Codex              | Code edits — external executor tool                          | `exec-context.md` + task CONTEXT + standards |
| GitHub Copilot     | Code edits — IDE-integrated assistant                        | `exec-context.md` + task CONTEXT + standards |
| Shell runner       | Shell tasks — terminal                                       | Task file only                               |
