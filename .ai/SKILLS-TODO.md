...
| Runtime / framework | core      | ✅      | .NET + Optimizely CMS          |
| Package manager     | core      | ❓      | —                              |
| Build tool          | core      | ❓      | —                              |
| Test framework      | core      | ❓      | —                              |
| Frontend framework  | core      | ✅      | TypeScript + SCSS + Handlebars |
| CSS approach        | core      | ✅      | SCSS                           |
| Database            | core      | ❓      | —                              |
| ORM / query builder | module    | ❓      | —                              |
| Auth pattern        | module    | ❓      | —                              |
| Deployment target   | module    | ❓      | —                              |
| Integration         | module    | ✅      | Salesforce                     |
...
## Operational skill files (VS Code Copilot)

| Skill         | Location                                | Purpose                                     |
| ------------- | --------------------------------------- | ------------------------------------------- |
| ticket-review | `.github/skills/ticket-review/SKILL.md` | Jira ticket → review doc + task files       |
| pr-review     | `.github/skills/pr-review/SKILL.md`     | Azure DevOps PR review against requirements |
| unit-tests    | `.github/skills/unit-tests/SKILL.md`    | C# xUnit + NSubstitute test generation      |
